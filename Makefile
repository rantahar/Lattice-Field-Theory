...
html: Makefile build/lattice.tex src/lattice.lyx
	pandoc -s --toc --mathjax="https://cdnjs.cloudflare.com/ajax/libs/mathjax/2.7.5/MathJax.js?config=TeX-MML-AM_CHTML" -f latex -t html < build/lattice.tex > index.html
